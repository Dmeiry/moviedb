...
function calculateConnectToOptions(xformOrOptions) {
    ...
    if (ld.isFunction(xformOrOptions))
        return Object.assign(Object.assign({}, defaultUseConnectToOptions), { xform: xformOrOptions });
    const noUndefOptions = ld.omitBy(xformOrOptions, ld.isUndefined);
    return Object.assign(Object.assign({}, defaultUseConnectToOptions), noUndefOptions);
}
