    ...
    return () => {
        ...
        for (const propName in properties) {
            if (propName.startsWith("x-"))
                continue; // Do not try to process custom extensions
...
function jsonSchema2GraphQLType(name, schema, tyResolverIn, inputType) {
    ...
    if (inputType) {
        ...
        if (!ld.isFunction(fields))
            return fields;
        return new graphql_1.GraphQLInputObjectType(Object.assign(Object.assign({}, consArgs), { fields }));
    }
    else {
        ...
        if (!ld.isFunction(fields))
            return fields;
        return new graphql_1.GraphQLObjectType(Object.assign(Object.assign({}, consArgs), { fields }));
    }
}
