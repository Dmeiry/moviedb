...
export declare class CFStackBase extends Component<CFStackProps, CFStackState> {
    ...
    initialState(): {};
    build(): Adapt.JSX.Element | null;
}
/** @beta */
export declare function isCFStackPrimitiveFinalElement(val: any): val is FinalDomElement<CFStackPrimitiveProps>;
/** @beta */
export declare const CFStack: (props: Pick<CFStackPrimitiveProps, "children" | "OnFailure" | "Tags" | "awsCredentials" | "TemplateBody" | "TemplateURL" | "Parameters" | "DisableRollback" | "RollbackConfiguration" | "TimeoutInMinutes" | "NotificationARNs" | "Capabilities" | "ResourceTypes" | "RoleARN" | "StackPolicyBody" | "StackPolicyURL" | "ClientRequestToken" | "EnableTerminationProtection"> & Record<"StackName", string | import("../resource_id/resource_id").ResourceId | null> & Adapt.WithChildren) => Adapt.JSX.Element;
export {};
