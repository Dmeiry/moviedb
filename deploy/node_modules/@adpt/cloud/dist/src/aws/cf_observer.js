...
function swaggerDef() {
    if (_swaggerDef)
        return _swaggerDef;
    const text = fs_extra_1.default.readFileSync(path_1.default.join(__dirname, "cloudformation_swagger.yaml"));
...
exports.AwsCfObserver = AwsCfObserver;
core_1.registerObserver(new AwsCfObserver());
//# sourceMappingURL=cf_observer.js.map