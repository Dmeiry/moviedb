import Adapt, { Component, Constructor, Context, PropsType, WithChildren } from "@adpt/core";
/** @beta */
...
/** @beta */
export declare function withCredentials<W extends Constructor<Component<any, any>>>(Wrapped: W, Ctx?: AwsCredentialsContext): (props: PropsType<W> & WithChildren) => Adapt.JSX.Element;
/** @beta */
