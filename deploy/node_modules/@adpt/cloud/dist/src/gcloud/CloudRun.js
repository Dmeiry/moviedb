...
exports.CloudRunAdapter = exports.makeCloudRunName = exports.CloudRun = void 0;
...
class CloudRun extends action_1.Action {
    ...
    async url() {
        var _a;
        const statObj = await this.describe();
        return (_a = statObj === null || statObj === void 0 ? void 0 : statObj.status) === null || _a === void 0 ? void 0 : _a.url;
    }
    initialState() { return {}; }
    mountedElement() {
    ...
    async describe() {
        ...
        const url = (_a = statObj === null || statObj === void 0 ? void 0 : statObj.status) === null || _a === void 0 ? void 0 : _a.url;
        this.setState({ url });
        return statObj;
    }
}
...
function CloudRunAdapter(propsIn) {
    ...
    let crElem = null;
    if (image) {
        const crProps = Object.assign(Object.assign({}, propsNoHandle), { image });
    ...
    return core_1.default.createElement(core_1.Sequence, null,
        core_1.default.createElement(docker_1.RegistryDockerImage, { handle: regImage, imageSrc: props.image, registryPrefix: props.registryPrefix }),
        crElem);
}
