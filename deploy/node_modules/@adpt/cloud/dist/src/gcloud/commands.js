...
exports.execGCloud = exports.cloudRunDelete = exports.cloudRunUpdateTraffic = exports.cloudRunDeploy = exports.cloudRunDescribe = exports.exec = exports.debugOut = void 0;
...
exports.debugOut = debug_1.default("adapt:cloud:gcloud:out");
exports.exec = utils_1.debugExec(debug, exports.debugOut);
...
async function execGCloud(args, globalOpts, options = {}) {
    ...
    return exports.exec("gcloud", fullArgs, options);
}
