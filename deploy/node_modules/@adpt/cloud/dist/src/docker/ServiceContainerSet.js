...
exports.ServiceContainerSet = void 0;
...
function mapContainer(absEl, spProps, helpers, portBindings) {
    ...
    const finalProps = Object.assign(Object.assign(Object.assign({}, absProps), containerProps), { key: absEl.props.key });
    if (spProps.dockerHost)
        finalProps.dockerHost = spProps.dockerHost;
    // Add the port bindings from the NetworkServices
    if (portBindings) {
        finalProps.portBindings = Object.assign(Object.assign({}, (finalProps.portBindings || {})), portBindings);
    }
