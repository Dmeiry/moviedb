...
exports.mightBeId = exports.containerNetworks = exports.NetworkSet = void 0;
...
class NetworkSet {
    ...
    add(items) {
        utils_1.toArray(items).forEach((i) => this._addOne(i));
    }
    async equals(namesOrIds, resolver) {
    ...
    _diff(namesOrIds) {
        const toAdd = new Set();
        const toDelete = new Set([...this.byName.keys()]);
 ...
 * @internal
 */
function containerNetworks(info) {
...
exports.containerNetworks = containerNetworks;
 ...
 * @internal
 */
function mightBeId(name) {
    if (name.length < 1 || name.length > 64)
        return false;
    return idRegex.test(name);
}
exports.mightBeId = mightBeId;
//# sourceMappingURL=network_set.js.map