...
/** @public */
export declare type Spec = DaemonSetSpec | DeploymentSpec | PodSpec | ServiceSpec | CRSpec;
/** @public */
...
export declare type ResourceProps = {
    key: string;
} & (ResourceClusterRole | ResourceClusterRoleBinding | ResourceDaemonSet | ResourcePod | ResourceService | ResourceServiceAccount | ResourceConfigMap | ResourceSecret | ResourceCR);
/** @public */
