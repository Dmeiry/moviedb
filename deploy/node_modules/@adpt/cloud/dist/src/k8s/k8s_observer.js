...
exports.K8sObserver = exports.K8sResponseError = exports.K8sNotFound = void 0;
...
const k8sSwagger = require("../../src/k8s/kubernetes-1.18-swagger.json");
...
const k8sObserveResolverFactory = {
    fieldResolvers: (_type, fieldName, isQuery) => {
        ...
        return async (obj, args, context, _info) => {
            ...
            const resp = await node_fetch_1.default(url, Object.assign(Object.assign({}, req), { headers }));
