...
function mapContainer(absEl, props, helpers) {
    const { config, containerProps: rawContainerProps = {}, podProps = {}, 
    // tslint:disable-next-line: variable-name
    component: MyComponent, componentProps } = props;
    ...
    if (config.registryPrefix !== undefined) {
        ...
        if (!lodash_1.default.isString(image)) {
            ...
            registryImage = core_1.default.createElement(docker_1.RegistryDockerImage, { handle: regImg, registryPrefix: config.registryPrefix, imageSrc: image });
            image = regImg;
        }
        else {
    ...
    const elem = core_1.default.createElement(MyComponent, Object.assign({}, Object.assign({ config }, componentProps)),
        core_1.default.createElement(Pod_1.Pod, Object.assign({ isTemplate: true, key: absEl.props.key }, podProps),
...
ServiceDeployment.defaultProps = {
    component: Deployment_1.Deployment,
