import Adapt, { BuildData, BuiltinProps, Handle, ObserveForStatus, SFCDeclProps } from "@adpt/core";
import { Omit } from "@adpt/utils";
import { NetworkServiceProps } from "../NetworkService";
import { ClusterInfo, Metadata, ResourceBase, ResourcePropsWithConfig } from "./common";
/** @public */
 ...
 * @public
 */
export declare function Service(propsIn: SFCDeclProps<ServiceProps, typeof defaultProps>): Adapt.JSX.Element;
