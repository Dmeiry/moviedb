...
exports.makeManifest = exports.labelKey = exports.resourceElementToName = exports.deployIDToLabel = exports.resourceIdToName = exports.registerResourceKind = exports.getResourceInfo = void 0;
...
const deployIDToLabelInner = common_1.makeResourceName(/[^a-z0-9-]/g, 63);
exports.deployIDToLabel = (id) => deployIDToLabelInner(id, "", id);
...
exports.labelKey = (id) => `adaptjs.org/${id}`;
function makeManifest(elem, deployID) {
    ...
    const ret = {
        ...
        metadata: Object.assign(Object.assign({}, elem.props.metadata), { name }),
        spec: elem.props.spec
    };
    if (ret.metadata.annotations === undefined)
        ret.metadata.annotations = {};
    const labels = ret.metadata.labels;
    ret.metadata.labels = Object.assign(Object.assign({}, (labels ? labels : {})), { [exports.labelKey("name")]: name, [exports.labelKey("deployID")]: exports.deployIDToLabel(deployID) });
    ret.metadata.annotations[exports.labelKey("name")] = elem.id;
    ret.metadata.annotations[exports.labelKey("deployID")] = deployID;
    return ret;
}
