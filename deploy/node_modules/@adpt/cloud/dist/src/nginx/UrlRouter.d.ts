...
import { UrlRouterProps as AbsUrlRouterProps } from "../http";
 ...
 * @public
 */
export declare function UrlRouter(propsIn: SFCDeclProps<UrlRouterProps, typeof defaultProps>): Adapt.JSX.Element;
