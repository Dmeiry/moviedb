...
exports.getResourceIds = exports.updateResourceIdState = exports.resourceIdConfig = exports.idToString = exports.resourceIdList = exports.ResourceIdPolicy = void 0;
...
function resourceIdConfig(id, policy, options) {
    if (isResourceId(id)) {
        return {
            baseId: id.baseId,
            options: Object.assign(Object.assign(Object.assign({}, defaultIdOptions), options), id.options),
    ...
    if (lodash_1.isNull(id) || typeof id === "string") {
        return {
            baseId: id,
            options: Object.assign(Object.assign({}, defaultIdOptions), options),
            policy
        };
    }
    return undefined;
