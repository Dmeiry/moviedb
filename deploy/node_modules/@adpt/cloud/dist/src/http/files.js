...
exports.fileHandles = exports.useFilesInfo = exports.useResolvedFiles = void 0;
...
function useResolvedFiles(files) {
    ...
    setResolved(() => {
        ...
        for (const f of files) {
            ...
            const imgName = image && lodash_1.isObject(image) && lodash_1.isString(image.nameTag) ? image.nameTag : null;
            if (image && !imgName) {
                throw new Error(`Cannot use container image as file source. Image exists but does not have a tag.`);
            }
            if (imgName) {
                done.push(Object.assign(Object.assign({}, f), { image: imgName }));
            }
            else {
                return undefined;
            }
