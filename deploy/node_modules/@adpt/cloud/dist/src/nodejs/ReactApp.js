...
function ReactApp(props) {
    const bProps = props;
    const buildOptions = Object.assign(Object.assign({}, defaultBuildOptions), bProps.buildOptions);
    ...
    const httpOptions = Object.assign(Object.assign(Object.assign({}, defaultHttpOptions), bProps.httpOptions), { add });
