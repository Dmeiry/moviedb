...
const defaultRetryDelayOptions = {
    cancel: () => false,
    factor: 2,
    maxTimeoutMs: 1000,
    minTimeoutMs: 100,
...
function rand(min, max) {
    return crypto_1.randomBytes(4).readUInt32BE(0) * (max - min) / 0xffffffff + min;
}
exports.rand = rand;
/**
...
function makeRetryDelay(options = {}) {
    ...
    return (attempt) => {
        ...
        if (exiting || attempt >= opts.retries || opts.cancel())
            return -1;
...
exports.makeRetryDelay = makeRetryDelay;
