...
export declare type ExitHandler = (signal: string, details?: Error | number) => MaybePromise<void | any>;
 ...
 * resolves.
 */
export declare function onExit(handler: ExitHandler): RemoveHandler;
