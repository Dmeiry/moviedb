...
exports.domFromStream = exports.domFromString = exports.domFromXMLObj = exports.handleShortProp = void 0;
...
function extractDOMObject(xmlNode) {
    ...
    return new dom_1.DOMObject(uri, utils_1.parseJson5(json));
}
...
function extractProp(prop) {
    try {
        return utils_1.parseJson5(extractSoleText(prop));
    }
    catch (err) { /* */ }
...
function extractStringArray(xmlNode) {
    ...
    const data = utils_1.parseJson5(dataJson);
