...
exports.findNodeModulesParent = exports.findPackageInfo = void 0;
...
function findPackageInfo(dir) {
    ...
    const pkgJson = ret === null || ret === void 0 ? void 0 : ret.packageJson;
    if (!ret || !pkgJson || !pkgJson.name || !pkgJson.version) {
 ...
 * undefined.
 */
function findNodeModulesParent(dir) {
    let lastParent;
    dir = path.resolve(dir);
    while (true) {
        const parsed = path.parse(dir);
        if (parsed.base === "node_modules")
            lastParent = parsed.dir;
        if (parsed.dir === dir)
            return lastParent;
        dir = parsed.dir;
    }
}
exports.findNodeModulesParent = findNodeModulesParent;
