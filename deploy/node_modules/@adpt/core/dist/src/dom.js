...
exports.domPathToString = exports.processStateUpdates = exports.buildOnce = exports.build = exports.isBuildOutputSuccess = exports.noStateUpdates = exports.isBuildOutputError = exports.isBuildOutputPartial = exports.makeElementStatus = void 0;
...
class BuildResults {
    ...
    message(msg, err) {
        ...
        const copy = Object.assign(Object.assign({}, msg), { content, timestamp: msg.timestamp ? msg.timestamp : Date.now(), from: msg.from ? msg.from : "DOM build" });
...
function doOverride(path, key, styles, options) {
    ...
    if (overrideFound != null) {
        ...
        const props = Object.assign(Object.assign({}, key), { override,
            element,
...
function computeOptions(optionsIn) {
    ...
    return Object.assign(Object.assign(Object.assign({}, defaultBuildOptions), optionsIn), { buildPass: 0 });
}
// Simultaneous builds
let buildCount = 0;
...
async function buildOnce(root, styles, options) {
    return build(root, styles, Object.assign(Object.assign({}, options), { buildOnce: true }));
}
...
async function pathBuildOnceGuts(path, styles, options, results) {
    ...
    try {
        const once = await realBuildOnce(path, null, styles, Object.assign(Object.assign({}, options), { buildNum }), null);
...
async function realBuildOnce(pathIn, parentStateNamespace, styles, options, predecessor, workingElem) {
    ...
    try {
        ...
        if (jsx_1.isMountedElement(oldElem)) {
            if (jsx_1.isElementImpl(oldElem) && oldElem.reanimated) {
