...
class WidgetPlugin {
    ...
    translatePairs(actions, pairs, actionType, action) {
        for (const p of pairs) {
            ...
            actions.push(Object.assign(Object.assign({}, p.actionInfo), { act: async () => {
                    try {
    ...
    for (const e of expected) {
        ...
        switch (actionInfo.type) {
            case deploy_types_1.ChangeType.create:
                actionList.push(Object.assign(Object.assign({}, pair), { element: e.to }));
                break;
            case deploy_types_1.ChangeType.none:
                ...
                actionList.push(Object.assign(Object.assign({}, pair), { element }));
                break;
            case deploy_types_1.ChangeType.delete:
                ...
                actionList.push(Object.assign(Object.assign({}, pair), { observed: o }));
                break;
            case deploy_types_1.ChangeType.modify:
            case deploy_types_1.ChangeType.replace:
                actionList.push(Object.assign(Object.assign({}, pair), { element: e.to, observed: o }));
                break;
        }
    }
