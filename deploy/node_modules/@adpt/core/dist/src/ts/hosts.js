...
exports.MemFileHost = exports.chainHosts = exports.MemoryHost = exports.FileSystemHost = exports.HostFinal = exports.ChainableHost = exports.debugDir = exports.debugChainableHostsVerbose = exports.debugChainableHosts = void 0;
...
function callSource(proto, propKey, desc) {
    return Object.assign(Object.assign({}, desc), { value: function _toSource(...args) {
            if (!this.source)
