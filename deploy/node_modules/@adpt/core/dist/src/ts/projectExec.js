...
exports.mockAdaptContext = exports.projectExec = exports.getAdaptContext = exports.createAdaptContext = void 0;
...
function createAdaptContext(projectRoot) {
...
function mockAdaptContext() {
    ...
    return Object.assign(Object.assign({}, ctx), { stop: () => {
            if (!oldContext)
                delete g.getAdaptContext;
            else
                g.getAdaptContext = oldContext;
        } });
}
