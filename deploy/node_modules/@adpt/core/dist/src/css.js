...
exports.concatStyles = exports.Style = exports.findPathsInDom = exports.findElementsInDom = exports.buildStyles = exports.ruleNoRematch = exports.copyRuleMatches = exports.canMatch = exports.neverMatch = exports.ruleMatches = exports.ruleHasMatched = exports.createMatchInfoReg = exports.rule = exports.Rule = exports.$matchInfoReg = void 0;
const tslib_1 = require("tslib");
const util = tslib_1.__importStar(require("util"));
const cssWhat = tslib_1.__importStar(require("css-what"));
...
function matchNot(frag, path) {
    ...
    if (typeof frag.data === "string") {
        throw new error_1.InternalError(`CSS ":not" - unexpected string data`);
    }
