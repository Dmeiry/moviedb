...
exports.getComponentConstructorData = exports.popComponentConstructorData = exports.pushComponentConstructorData = exports.setComponentConstructorStack_ = exports.simplifyChildren = exports.childrenToArray = exports.childrenIsEmpty = exports.cloneElement = exports.createElement = exports.AdaptPrimitiveElementImpl = exports.AdaptDeferredElementImpl = exports.defaultDeployedWhen = exports.AdaptElementImpl = exports.isComponent = exports.isPrimitive = exports.PrimitiveComponent = exports.isDeferred = exports.DeferredComponent = exports.Component = exports.componentStateNow = exports.isPartialFinalDomElement = exports.isFinalDomElement = exports.isSFCElement = exports.isComponentElement = exports.isMountedPrimitiveElement = exports.isPrimitiveElement = exports.isDeferredElementImpl = exports.isDeferredElement = exports.isMountedElement = exports.isElementImpl = exports.isElement = exports.isApplyStyle = exports.ApplyStyle = void 0;
...
class AdaptElementImpl {
    constructor(componentType, props, children) {
        ...
        hand.associate(this);
        this.props = Object.assign(Object.assign({}, props), { handle: hand });
...
function defaultDeployedWhen(el) {
    ...
    return (_goalStatus, helpers) => {
        ...
        return helpers.isDeployed(succ.props.handle) ? true :
            relations_1.waiting(`Waiting on successor element (${succ.componentName})`, [succ.props.handle]);
    };
}
...
props, ...children) {
    ...
    if (ctor.defaultProps) {
        ...
        fixedProps = Object.assign(Object.assign({}, ctor.defaultProps), props);
    }
...
function cloneElement(element, props, ...children) {
    ...
    const newProps = Object.assign(Object.assign({}, elProps), props);
 ...
 * @public
 */
function childrenIsEmpty(propsChildren) {
    return childrenToArray(propsChildren).length === 0;
}
exports.childrenIsEmpty = childrenIsEmpty;
