...
import { AdaptElement, AdaptElementOrNull, AdaptMountedElement, FinalDomElement, PartialFinalDomElement } from "./jsx";
...
export declare function makeElementStatus(observerManager?: ObserverManagerDeployment): (handle: Handle) => Promise<any>;
