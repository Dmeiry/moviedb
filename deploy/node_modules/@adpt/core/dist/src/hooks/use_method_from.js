...
exports.useMethodFrom = void 0;
const imperative_1 = require("./imperative");
const use_method_1 = require("./use_method");
/**
 ...
 * @public
 */
function useMethodFrom(provider, methodName, defaultVal) {
    imperative_1.useImperativeMethods(() => ({
        [methodName]: (...args) => provider ? use_method_1.callInstanceMethod(provider, defaultVal, methodName, ...args) : defaultVal
    }));
}
exports.useMethodFrom = useMethodFrom;
//# sourceMappingURL=use_method_from.js.map