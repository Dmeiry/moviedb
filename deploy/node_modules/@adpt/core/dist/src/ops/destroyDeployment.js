...
exports.destroyDeployment = void 0;
const server_1 = require("../server");
const deployment_1 = require("../server/deployment");
const common_1 = require("./common");
async function destroyDeployment(optionsIn) {
    const options = Object.assign(Object.assign({}, common_1.defaultDeployCommonOptions), optionsIn);
    const setup = {
    ...
    return common_1.withOpsSetup(setup, async (info) => {
        ...
        if (!options.dryRun) {
            await deployment_1.destroyDeployment(server, deployID);
        }
        return {
            type: "success",
