...
async function fetchStatus(options) {
    const finalOptions = Object.assign(Object.assign(Object.assign({}, common_1.defaultDeployCommonOptions), defaultOptions), options);
    ...
    return common_1.withOpsSetup(setup, async (info) => {
        ...
        try {
            ...
            await buildAndDeploy_1.withContext(currState, async (ctx) => {
                result = await tasks.status.complete(() => buildAndDeploy_1.build(Object.assign(Object.assign({}, currState), { taskObserver,
                    ctx, withStatus: true })));
