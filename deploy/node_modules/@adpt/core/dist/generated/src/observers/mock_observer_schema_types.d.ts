...
export declare type MockObject = {
    __typename?: 'MockObject';
    id: Scalars['ID'];
    idSquared?: Maybe<Scalars['Int']>;
    idPlusOne?: Maybe<Scalars['Int']>;
};
export declare type Query = {
    __typename?: 'Query';
    mockById?: Maybe<MockObject>;
};
export declare type QueryMockByIdArgs = {
    id: Scalars['ID'];
};
...
export declare type ResolversTypes = ResolversObject<{
    ...
    MockObject: ResolverTypeWrapper<MockObject>;
...
export declare type MockObjectResolvers<ContextType = any, ParentType extends ResolversParentTypes['MockObject'] = ResolversParentTypes['MockObject']> = ResolversObject<{
    id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
    idSquared?: Resolver<Maybe<ResolversTypes['Int']>, ParentType, ContextType>;
    idPlusOne?: Resolver<Maybe<ResolversTypes['Int']>, ParentType, ContextType>;
...
export declare type QueryResolvers<ContextType = any, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = ResolversObject<{
    mockById?: Resolver<Maybe<ResolversTypes['MockObject']>, ParentType, ContextType, RequireFields<QueryMockByIdArgs, 'id'>>;
}>;
export declare type Resolvers<ContextType = any> = ResolversObject<{
    MockObject?: MockObjectResolvers<ContextType>;
...
//# sourceMappingURL=mock_observer_schema_types.d.ts.map